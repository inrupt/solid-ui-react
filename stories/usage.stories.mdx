...
```
import { SessionProvider, LoginButton } from "@inrupt/solid-react-ui";
```
...
as you have a SessionProvider, you can use a
...
From there, you can click "login" using the default "https://inrupt.net"
identity provider. Click the "register" link on the bottom. You will then be
redirected to your new pod.
...
```
import { useSession, CombinedDataProvider, Text } from "@inrupt/solid-react-ui";
```
